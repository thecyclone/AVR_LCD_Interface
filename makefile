...
elf_file = lcd.elf                       #This is the variable created to store the elf file
c_file = lcd.c                           #This is the variable created to store the c file
hex_file = lcd.hex                       # It is the variable created to store the hex file
objs = lcd.elf lcd.hex                   # This variable stores all the object files that will be created during the execution of code
